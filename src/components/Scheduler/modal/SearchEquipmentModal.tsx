...
export default function SearchEquipmentModal({
  open,
  onClose,
  onSelect,
  janela,
  grupos = [
    { id: 10, nome: "Monitores" },
    { id: 11, nome: "Instrumentos Cirúrgicos" },
    { id: 12, nome: "Mesas e Suportes" },
    { id: 13, nome: "Equipamentos de Diagnóstico" },
  ],
}: Props) {
         ...
         <DialogContent className="w-[90vw]  max-w-3xl max-h-[95vh]  rounded-2xl  z-[61]">
          ...
          <div className="p-6 border-b">
            <DialogHeader>
              ...
              <DialogDescription>
                Selecione filtros e veja os recursos disponíveis na
                janela:&nbsp;
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <div className="col-span-12">
                <Label>Grupo de Equipamento (opcional)</Label>
                <Select
            ...
            {/* Tabela SEMPRE renderizada */}
            <div className="mt-1 max-h-80 overflow-auto rounded-2xl border relative">
              <table className="w-full text-sm table-fixed">
                <colgroup>
                  <col className="w-20" /> {/* Selecionar */}
                  <col /> {/* Recurso */}
                  <col className="w-32" /> {/* Situação */}
                </colgroup>
                    ...
                    resultado.map((r) => {
                      ...
                      return (
                        <tr key={r.id} className="border-t align-middle">
                          ...
                          <td className="py-2 px-3">
                            {r.disponivel ? (
                              <span className="text-green-600 text-xs inline-flex items-center gap-1 whitespace-nowrap">
                                <Check className="h-3 w-3" />
                                Disponível
                              </span>
                            ) : (
                              <span className="text-red-600 text-xs inline-flex items-center gap-1 whitespace-nowrap">
                                <X className="h-3 w-3" />
                                Bloqueado
                              </span>
                            )}
